...
- NOT verified: any Spark/Unity Catalog cell, model-registry permissions, volume paths, `bundle deploy`, Genie availability on Free Edition. Needs a teammate with a workspace; catalog name default `workspace` is unconfirmed.
