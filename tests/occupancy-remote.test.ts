...
const garage = (): Garage => ({ id: "perry-street", name: "P", lat: 0, lon: 0, footprint: [], center: { lon: 0, lat: 0 }, levels: [{ label: "old", classes: [], capacity: 10, occupied: 1, adaCapacity: 1, adaOccupied: 0 }], info });
