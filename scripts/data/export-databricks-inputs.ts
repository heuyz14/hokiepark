...
for (const f of ["data/raw/timetable.json", "data/reference/timetable-building-codes.json", "databricks/data/building_points.json", "databricks/data/garages.json", "databricks/data/units.json"]) {
