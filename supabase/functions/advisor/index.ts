// GENERATED by scripts/build/build-advisor.ts (npm run advisor:build). Do not edit by hand: change handler.ts / advisor-spec.ts and rebuild.
...
var TOOL_NAMES = ["find_place", "plan_parking", "parking_now", "arrival_advice", "permit_check", "garages_now", "accessible_parking", "calculate_walk_route", "compare_parking_options"];
var LIMITS = {
  questionChars: 300,
  historyMessages: 24,
  partsPerMessage: 8,
